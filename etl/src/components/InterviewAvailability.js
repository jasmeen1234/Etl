  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <label>
        Email:
        <br></br>
        <input type="email" value={email}  placeholder="Example-userid@gmail.com" onChange={(e) => setEmail(e.target.value)} required />
      </label>
      ...
      <label>
        Location:
        <br></br>
        <input type="text"  placeholder="search or enter your location" value={location} onChange={(e) => setLocation(e.target.value)} required />
      </label>
      ...
      <label>
        ...
        <input type="time"  placeholder="12:00" value={interviewTime} onChange={(e) => setInterviewTime(e.target.value)} required />
      </label>
      <br></br>
      <label>
        Time Zone:   <br></br>
     ...
     <br></br>
      <label>
        ...
        <select value={interviewMedium} onChange={(e) => setInterviewMedium(e.target.value)} required>
